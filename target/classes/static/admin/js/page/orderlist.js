$(function () {
    ...
    function build_orders_table(result) {
        ...
        $.each(orders, function (index, item) {
            ...
            var ticketPrice = $("<td></td>").append(item.ticketPrice.toFixed(1));
            ...
            $("<tr></tr>").append(checkBox).append(id).append(trueName).append(phoneNum).append(carNum).append(orginLocation).append(destinationLocation).append(startTime).append(reachTime).append(ticketPrice).append(status)
