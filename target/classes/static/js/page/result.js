...
if (queryResult != ''){
    ...
    for (var i in queryResult){
        ...
        showContent += '<div class="one_line">\n' +
            ...
            '                <span style="font-size: xx-large">' + queryResult[i].startTime.substring(5,16) + '</span>\n' +
            '                <br>\n' +
            ...
            '        <div class="col-sm-3">\n' +
            '            <p style="padding: 10px">\n' +
            '                <span style="font-size: xx-large">' + queryResult[i].reachTime.substring(5,16) + '</span><span id="spanDays-show" style="color: #f05050">' + spanDays + '</span>\n' +
            '                <br>\n' +
